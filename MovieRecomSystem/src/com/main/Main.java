...
public class Main {
	...
	public static void PredictUnrated() {
		...
		System.out.println("Total User size is : "+ uSize);
		int mSize = movieList.size();
		System.out.println("Total Movie size is : "+ mSize);
		...
		if (new File("res/rating.txt").exists()) {
			...
			System.out.println("rating matrix don't exist.\nGenerating...Please wait...");
		...
		predict.PredictUnratedMovies(rating, sg, "res/predictSource.txt", userList, movieList);
